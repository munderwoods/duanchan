<template>
  <div class="about flex-column">
    ...
    <div class="fine-print">
      ...
      DuangChan unless otherwise defined in this Privacy
      Policy.
      </p> <p><strong>Information Collection and Use</strong></p> <p>
      For a better experience, while using our Service,
      I may require you to provide us with certain
      personally identifiable information, including but not limited to Username, Password, Email. The
      ...
      me at matthewsunderwood@gmail.com.
      </p>
    </div>
